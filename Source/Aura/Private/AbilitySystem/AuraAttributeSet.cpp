...
{
	// create the key value pair between delegates and gameplay tags, binding the static accessors functions
	// this uses the template function pointers we created in the header file
...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	// primary attribute rep notify binding
	...
	// secondary attribute rep notify binding
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	// clamp the health and mana attributes a second time to ensure proper clamping
